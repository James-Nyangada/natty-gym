      ...
      <section>
        ...
        <div className="bg-white py-[12rem] page-padding grid grid-cols-2 container gap-10 items-center md1000:grid-cols-1 ">
          ...
          <div className="md1000:w-[60%] md1000:flex md1000:flex-col md1000:mx-auto min800:w-[90%] min620:w-full">
            ...
            <div className="grid grid-cols-2 grid-rows-2 gap-y-20 min620:grid-cols-1 min620:mx-auto">
              <div className="flex flex-col relative">
                ...
                <span className="bg-[#FFCC00] w-[50px] h-[4px] absolute top-[33px]"></span>
              ...
              <div className="flex flex-col relative">
                ...
                <div className="text-[15px] font-medium text-[#646464]">
                  <p>Mon to Fri: 7:30 am — 10:00 am</p>
                  <p>Mon to Fri: 7:30 am — 10:00 am</p>
                </div>
              </div>
              {/*  */}
              ...
              <div className="flex flex-col relative">
                ...
                <div className="text-[18px] font-medium text-black flex gap-5">
                  <a href="">
                  <i className="fa-brands fa-facebook-f px-[16px] py-[13px] bg-[#f4f4f4] rounded-full cursor-pointer hover:bg-[#FFCC00] ease-in duration-200 hover:text-white"></i>
                  </a>
                  
                  <a href="">
                  <i className="fa-brands fa-twitter p-[13.5px] bg-[#f4f4f4] rounded-full cursor-pointer hover:bg-[#FFCC00] ease-in duration-200 hover:text-white"></i>
                  </a>

                  <a href="">
                  <i className="fa-brands fa-instagram p-[13.5px] bg-[#f4f4f4] rounded-full cursor-pointer hover:bg-[#FFCC00] ease-in duration-200 hover:text-white"></i>
                  </a>
                  
                  <a href="">
                  <i className="fa-brands fa-pinterest-p p-[13.5px] bg-[#f4f4f4] rounded-full cursor-pointer hover:bg-[#FFCC00] ease-in duration-200 hover:text-white"></i>
                  </a>
          ...
          <form className="flex flex-col pt-[30px] pr-[50px] pb-[50px] pl-[45px] bg-[#f8f8f8] relative md1000:w-[65%] md1000:flex md1000:flex-col md1000:mx-auto md1000:mt-14 min800:w-[90%] min620:w-full">
            ...
            <span className="bg-[#FFCC00] w-[50px] h-[4px] absolute top-[77px]"></span>
            <input
            ...
            <button
              type="submit"
              className="text-black bg-[#FFCC00] w-fit py-[15px] px-[30px] font-bold text-[14px] uppercase self-center mt-6"
            >
              submit now
            </button>
          </form>
        ...
        {/* map */}
        <iframe
          src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d1994.4788386198745!2d36.93145260214807!3d-1.1900916929233967!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x182f3f31f236da67%3A0x1cb2d06ee6f238ad!2sNatty%20Gym%20Kahawa!5e0!3m2!1sen!2ske!4v1698035924897!5m2!1sen!2ske"
          allowFullScreen=""
          loading="lazy"
          samesite="Strict"
          title="map"
