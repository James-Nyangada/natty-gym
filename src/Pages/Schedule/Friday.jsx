  ...
  return (
    <>
      ...
      <div className="flex flex-wrap gap-4 justify-center">
        <Link
          to="/schedule/monday"
          className="text-[15px] font-bold border-solid border border-[#d7d7d7] py-[9px] px-[32px] rounded-[23px] hover:bg-[#FFCC00] ease-in duration-200 hover:shadow-2xl hover:text-black "
        >
          Monday
        </Link>
        ...
        <Link
          to="/schedule/tuesday"
          className="text-[15px] font-bold border-solid border border-[#d7d7d7] py-[9px] px-[32px] rounded-[23px] hover:bg-[#FFCC00] ease-in duration-200 hover:shadow-2xl hover:text-white "
        >
          Tuesday
        </Link>
        ...
        <Link
          to="/schedule/friday"
          className="text-[15px] font-bold border-solid border border-[#d7d7d7] py-[9px] px-[32px] rounded-[23px] bg-[#FFCC00] ease-in duration-200 hover:shadow-2xl text-white "
        >
          Friday
        </Link>
        ...
        <div className="flex flex-col gap-3">
          ...
          <ul className="flex justify-between w-full  min800:flex-col min800:text-center">
            ...
            <li className="py-[25px] px-[55px] bg-[#f2f2f2] w-full text-right min800:text-center">
              <button className="text-white text-[15px] font-medium bg-[#555] py-[10px] px-[20px] rounded-[30px] mt-3 hover:bg-[#FFCC00] ease-in duration-200 ">
                Join Now
              </button>
            </li>
          </ul>
