...
function Featured() {
  ...
  return (
    <>
      <section id="featured" className="page-padding py-[12.5rem] bg-white">
        <div className="container">
          ...
          <div className="flex flex-col text-center items-center relative ">
            <p className="font-bold text-black text-[15px] relative uppercase z-10 ">
              OUR FEATURED CLASS
            </p>
            <img
              src={TitleRed}
          ...
          <div className="grid grid-cols-4 grid-rows-2 gap-7 h-full mt-7 md1000:flex md1000:flex-col">
            <div className="item-0-div relative">
              ...
              <div className="absolute z-10 bottom-10 left-10">
                ...
                <p className="text-black bg-[#FFCC00] text-[16px] mt-3 py-1 px-5">
      ...
      {/* featured cta */}
      <div className="featured-cta flex justify-center text-left items-center md1000:bg-none md1000:bg-[#FFCC00] ">
