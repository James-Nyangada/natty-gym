...
function PricingBox({ img, title, price }) {
  return (
    <>
      <div className="flex flex-col w-1/3 md1000:w-[40rem] bg-white shadow-xl relative min540:w-[100%]">
        ...
        >
          ...
          <div className="absolute bg-white text-[20px] font-bold w-[25rem] text-center py-6 text-black -bottom-[18px] left-0 right-0 mx-auto">
            {title}
          </div>
        </div>
